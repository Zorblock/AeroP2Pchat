...
> **Note:** If you prefer downloading manually, you can grab the `.exe` (Windows), `.AppImage` (Linux), or `.apk` (Android) directly from our [Releases Page](https://github.com/Zorblock/AeroP2Pchat/releases) or the [Official Website](https://aero.zorblock.de).
