<div align="center">
  <img src="https://aero.zorblock.de/logo.png" alt="Aero P2P Chat Logo" width="150" height="150" />
...
> **Note:** If you prefer downloading the installer manually, you can grab the `.exe` (Windows) or `.AppImage` (Linux) directly from our [Releases Page](https://github.com/Zorblock/AeroP2Pchat/releases) or the [Official Website](https://aero.zorblock.de).
